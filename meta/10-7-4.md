...
source_organisation_1: <a href="https://www.unhcr.org/" target="_blank" onclick="return confirm_alert('des UNHCR','De');" title="Klicken Sie hier um zur Website der Organisation Hoher Flüchtlingskommissar der Vereinten Nationen (UNHCR) zu gelangen."> Hoher Flüchtlingskommissar der Vereinten Nationen (UNHCR) </a>
source_organisation_logo_1: <a href="https://www.unhcr.org/" target="_blank" onclick="return confirm_alert('des UNHCR','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/unhcr.png" alt="Logo unhcr" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
