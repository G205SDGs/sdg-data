...
# Nationale Metadaten    
national_indicator_available: Bruttoentwicklungsausgaben für den Forstsektor <br> Verpflichtungen (ODA) für Biodiversität    
comparison_sdg: 'Die Zeitreihe "Verpflichtungen (ODA) für Biodiversität" entspricht den globalen Metadaten. Die Zeitreihen "Bruttoentwicklungsausgaben für den Forstsektor" bietet zusätzliche Informationen.'    
...
source_url_1b: https://stats.oecd.org/qwids/
source_url_text_1b: OECD - Internationale Entwicklungsstatistik (nur auf Englisch verfügbar)
...
data_start_values: 
  ...
  - field: timeseries
    value: b) oda (gross disbursements) to the forestry sector    
computation_units: "Millionen USD, konstante Preise (2018)"    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2021'    
data_footnote:     

# Grafik Eigenschaften    
graph_title: Öffentliche Entwicklungszusammenarbeit für Biodiversität und den Forstsektor    
graph_type: line    
