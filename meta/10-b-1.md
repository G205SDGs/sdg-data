...
goal_meta_national_link_De: https://sdg-indikatoren.de/public/MetaDe/10.b.1.pdf
...
source_url_text_1b: 'OECD – Daten zur Entwicklungsfinanzierung (nicht auf Deutsch verfügbar) [Einstellungen: DAC1: Flows by provider (ODA+OOF+Private); Measure: Official and private flows, Official Development Assistance (ODA), Other Official Flows (OOF), Officially supported export credits, Private flows at market terms, rivate grants, net; Flow type: Disbursements, net]'
...
data_last_update: Zuletzt aktualisiert am 18.03.2026. Sobald Daten für weitere Berichtszeiträume vorliegen, werden diese zeitnah hinzugefügt.    
---
