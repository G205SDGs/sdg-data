...
goal_meta_national_link: https://sdg-indikatoren.de/public/MetaDe/11.6.2.pdf    
...
data_start_values: 
  ...
  - series: population with excessive exposure to fine particulate matter
    field: fine particulate matter
    value: pm2.5    
computation_units: Mikrogramm pro Kubikmeter; Millionen Einwohner/ -innen    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2022'    
footer_fields:
  - series: population weighted annual mean levels of pm10
    unit: micrograms per qubic meters
    label: Anmerkungen
    value: <br>• Die Daten zu PM10 basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.<br>• 2016 bis 2017 vorläufige Daten.
  - series: population with excessive exposure to fine particulate matter
    unit: mn inhabitants
    label: Anmerkung
    value: Die Daten zu PM10 basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.    
