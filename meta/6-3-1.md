...
comparison_sdg: 'Die Zeitreihe "Abwasser, das sicher behandelt wird oder nicht behandlungsbedürftig ist" entspricht den UN-Metadaten. Die Zeitreihe "Abwasser und Kühlwasser" bietet zusätzliche Informationen.'    
...
footer_fields:
  - series: wastewater that is safely treated or does not require treatment
    unit: percentage
    label: Anmerkung
    value: Ohne Kühlwasser und ungenutztem Wasser.    

# Grafik Eigenschaften    
graph_title: 
graph_subtitle:     
graph_type: bar
graph_stacked_disaggregation: type of treatment    
graph_limits:
  - unit: "percentage"
    minimum: 0.0
    maximum: 100.0
...
data_last_update: Zuletzt aktualisiert am 18.04.2023. Sobald Daten für weitere Berichtszeiträume vorliegen, werden diese zeitnah hinzugefügt.    
---
