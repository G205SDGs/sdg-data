...
source_organisation_2: <a href="https://www.bmel.de" target="_blank" onclick="return confirm_alert('des Bundesministeriums für Landwirtschaft, Ernährung und Heimat','De');" title="Klicken Sie hier um zur Website der Organisation Bundesministerium für Landwirtschaft, Ernährung und Heimat  (BMLEH) zu gelangen."> Bundesministerium für Landwirtschaft, Ernährung und Heimat  (BMLEH) </a>
source_organisation_logo_2: <a href="https://www.bmel.de" target="_blank" onclick="return confirm_alert('des Bundesministeriums für Landwirtschaft, Ernährung und Heimat','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/bmleh.png" alt="Logo bmleh" style="height:60px; width:148px"/></a>
