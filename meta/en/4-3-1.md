...
data_footnotes: 'The data are based on a special evaluation and are not publicly available.<br>• The 2020 results are only comparable with previous years to a limited extent. For more information, see the national metadata under "3. Data description".'    

# Grafik Eigenschaften    
graph_title: Participation rate in formal and non-formal education and training in the previous 12 months
    
graph_series_breaks:
  - label_content: Limited comparability
    value: 9.5
