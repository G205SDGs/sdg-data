...
data_footnotes: Total freshwater withdrawal also includes withdrawal by private households; therefore, the combined withdrawal figures for the various economic sectors do not add up to 100%.<br>• The data is based on a special evaluation and are not publicly available.    
