...
In Germany direct civil society participation in urban planning and management is regulated by the <a href="https://www.gesetze-im-internet.de/bbaug/" target="_blank" onclick="return confirm_alert('the Federal Ministry of Justice','En');">Federal Building Code (Baugesetzbuch, BauGB)</a>. As the BauGB applies to all cities and municipalities, a value of 100 % is assumed for the indicator.