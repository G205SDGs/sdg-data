...
goal_meta_national_link: https://sdg-indikatoren.de/public/Meta/10.2.1.pdf    
...
data_footnotes: 'Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• Median: Mean value of a data series sorted by size.'    
