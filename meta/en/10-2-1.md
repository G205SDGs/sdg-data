...
data_footnotes: 'Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 and 2021 are final results, for 2022 first results.<br>• Median: mean value of a data series sorted by size.'    
