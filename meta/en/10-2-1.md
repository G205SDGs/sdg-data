...
data_footnotes: 'Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 bis 2023 are final results.<br>• Median: mean value of a data series sorted by size.'    
