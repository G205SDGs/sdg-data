...
# Nationale Metadaten    
national_indicator_available: Adults with a defined minimum level of functional literacy    
...
# Globale Metadaten    
indicator_name: Youth/adult literacy rate    
...
data_footnote: "Functional literacy: The ability to understand, evaluate, use, and apply written texts in order to achieve one's own goals, develop knowledge, and actively participate in social life."    

# Grafik Eigenschaften    
graph_title: Adults with a defined minimum level of functional literacy
graph_subtitle:     

national_geographical_coverage: Germany    
data_last_update: Last updated on 2026/01/21. Data for further reporting periods will be added as soon as it becomes available.    
---
