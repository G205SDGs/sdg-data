...
data_footnotes: 'pH value: Measure of the strength of the acidic or alkaline effect of an watery solution.<br>• ph < 7 acidic.<br>• ph = 7 neutral.<br>• ph > 7 alkaline (basic).<br>• The data is based on a special evaluation and is not publicly available.'    
