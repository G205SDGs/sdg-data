...
footer_fields:
  ...
  - series: private persons (donors) suspected in the context of corruption offences
    unit: number
    label: Note
    value: The data relates to suspected bribe-givers with personal motives in cases of corruption offences. It also includes those bribe-givers whose attempt to bribe was rejected by the target.    
