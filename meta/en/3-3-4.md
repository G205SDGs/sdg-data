...
data_footnotes: Due to methodological changes, the results from 2015 (adjustments to the case definitions), from 2017 (adjustments to the Infection Protection Act (IfSG) and the reporting obligation) and from 2019 (adjustments to the case definitions) are only comparable with the previous years to a limited extent in each case.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.    
