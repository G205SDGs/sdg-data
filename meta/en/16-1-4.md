...
footer_fields:
  ...
  - series: population not living in an area with crime, violence or vandalism
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 bis 2023 are final results.
