...
source_url_1d: https://skid.bka.de/assets/files/SKiD2024_Ergebnisbericht.pdf
source_url_text_1d: Security and crime in Germany (SKiD 2024) (only available in German)
source_url_alert_1d: the Bundeskriminalamt
source_url_1e: https://skid.bka.de/
source_url_text_1e: SKiD-Dashboard (only available in German)
source_url_alert_1e: the Bundeskriminalamt
...
source_organisation_logo_3: <a href="https://ec.europa.eu/eurostat/en/home" target="_blank" onclick="return confirm_alert('the Statistical Office of the European Union','En');"><img src="https://sdg-indikatoren.de/public/OrgImgEn/eurostat.png" alt="Logo eurostat" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
...
data_last_update: Last updated on 2026/08/31. Data for further reporting periods will be added as soon as it becomes available.    
---
