...
footer_fields:
  ...
  - series: population living in a dwelling with a leaking roof, damp walls, floors or foundation, or rot in window frames or floor
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• 2020 to 2022 no data available.
  - series: population having neither a bath, nor a shower in their dwelling
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• Data is only available until 2020.
...
data_last_update: Last updated on 2025/04/28. Data for further reporting periods will be added as soon as it becomes available.    
---
