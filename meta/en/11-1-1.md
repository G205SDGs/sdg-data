...
footer_fields:
  - series: overcrowding rate
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 to 2022 are final results, for 2023 first results.
  ...
  - series: population having neither a bath, nor a shower in their dwelling
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 to 2022 are final results, for 2023 first results.<br>• Data is only available until 2020.
