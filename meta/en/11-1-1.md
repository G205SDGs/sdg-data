...
footer_fields:
  - series: overcrowding rate
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 to 2023 are final results.
  ...
  - series: population living in a dwelling with a leaking roof, damp walls, floors or foundation, or rot in window frames or floor
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 to 2023 are final results.<br>• 2020 to 2022 no data available.
  - series: population having neither a bath, nor a shower in their dwelling
    label: Notes
    value: <br>• Due to methodological changes, the results from 2020 onwards are only comparable with previous years to a limited extend.<br>• The results currently shown for 2020 to 2023 are final results.<br>• Data is only available until 2020.
