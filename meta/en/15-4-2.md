...
footer_fields:
  - series: (a) mountain green cover index
    label: Notes
    value: '<br>• The data is based on a special evaluation and is not publicly available.<br>• Nival: Highest altitude zone in the mountains, practically<br>• devoid of vegetation.<br>• <br>• <br>• <br>• Alpine: Altitude zone above the tree line but below<br>• the nival zone, with herbaceous vegetation.<br>• <br>• <br>• <br>• Montane: Altitude zone below the tree line.'
