...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>a) Zweigstellen von Zahlungsverkehrsdienstleistern</li> <li> b) Bankautomaten von inländischen Zahlungsdienstleistern</li></ul>"    
...
data_start_values: 
  - field: timeseries
    value: a) branches of payment service providers
  - field: timeseries
    value: b) atms of national payment service providers    
...
graph_title: a) Zweigstellen und b) Bankautomaten
graph_subtitle:     
graph_type: line
graph_stepsize: 
  - step: 20.0    
...
data_last_update: Zuletzt aktualisiert am 05.08.2025. Sobald Daten für weitere Berichtszeiträume vorliegen, werden diese zeitnah hinzugefügt.    
---
