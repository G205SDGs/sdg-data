...
# Nationale Metadaten    
national_indicator_available: "<ul style='padding-left: 25px;'><li>Finanzzusagen (ODA und OOF) zum Ausbau statistischer Kapazitäten in Entwicklungsländern</li> <li> Bruttozahlungen (ODA und OOF) zum Ausbau statistischer Kapazitäten in Entwicklungsländern</li></ul>"    
...
data_start_values: 
  - field: timeseries
    value: oda and oof (commitments) of all resources made available to strengthen statistical capacity in developing countries (mn usd, constant prices (2016))    
computation_units: "Millionen USD, konstante Preise (2018)"    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2021'    
data_footnote:     

# Grafik Eigenschaften    
graph_title: Zusagen und Bruttoauszahlungen (ODA und OOF) zum Ausbau statistischer Kapazitäten in Entwicklungsländern    
graph_type: line    
