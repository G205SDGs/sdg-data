...
data_start_values: 
  ...
  - field: time series
    value: oda and oof (commitments)
  - field: time series
    value: oda and oof (gross disbursements)    
    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2023'    
data_footnotes: 'ODA: Official Development Assistance (Entwicklungsausgaben).<br>• Oher Official Flows (Andere öffentliche Leistungen).'    
