...
footer_fields:
  - series: raw material consumption (rmc)
    unit: million tonnes
    label: Anmerkungen
    value: '<br>• BIP: Bruttoinlandsprodukt.<br>• RMC: Raw Material Consumption (inländische letzte Verwendung).'
  - series: raw material consumption (rmc)
    unit: tonnes per capita
    label: Anmerkungen
    value: '<br>• BIP: Bruttoinlandsprodukt.<br>• RMC: Raw Material Consumption (inländische letzte Verwendung).<br>• Für 2010 wurde die Bevölkerung anhand des Zensus 2011 sowie der Wanderungs-, Geburten- und Sterbestatistiken zurückgerechnet.'
