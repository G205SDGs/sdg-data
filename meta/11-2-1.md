...
source_organisation_logo_1: <a href="https://www.bbsr.bund.de/BBSR/DE/startseite/_node.html" target="_blank" onclick="return confirm_alert('des Bundesinstituts für Bau-, Stadt- und Raumforschung','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/bbsr.png" alt="Logo bbsr" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
...
source_organisation_logo_2: <a href="https://www.dlr.de/de" target="_blank" onclick="return confirm_alert('des Deutschen Zentrums für Luft- und Raumfahrt','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/dlr.png" alt="Logo dlr" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
...
data_last_update: Zuletzt aktualisiert am 03.11.2023. Sobald Daten für weitere Berichtszeiträume vorliegen, werden diese zeitnah hinzugefügt.    
---
