...
Deutschland ist Vertragspartei des <a href="https://www.fao.org/plant-treaty/countries/membership/country-details/en/c/359285/?iso3=DEU" target="_blank" onclick="return confirm_alert('der Ernährungs- und Landwirtschaftsorganisation der Vereinten Nationen','De');">Internationalen Vertrages über pflanzengenetische Ressourcen für Ernährung und Landwirtschaft (PGRFA)</a> sowie des <a href="https://www.cbd.int/abs/nagoya-protocol/signatories" target="_blank" onclick="return confirm_alert('des Sekretariats des Übereinkommens über die biologische Vielfalt','De');">Nagoya-Protokolls</a>. Zudem bestehen rechtliche, administrative und politische Rahmenbedingungen sowie Maßnahmen, die über das Online-Berichtssystem zur Einhaltung des Internationalen Vertrages über PGRFA oder über das <a href="https://absch.cbd.int/en/countries/DE" target="_blank" onclick="return confirm_alert('des Sekretariats des Übereinkommens über die biologische Vielfalt','De');">ABS Clearing-House</a> gemeldet werden.