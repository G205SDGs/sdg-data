...
source_organisation_2: <a href="https://www.bmas.de" target="_blank" onclick="return confirm_alert('des Bundesministeriums für Arbeit und Soziales','De');" title="Klicken Sie hier um zur Website der Organisation Bundesministerium für Arbeit und Soziales (BMAS) zu gelangen."> Bundesministerium für Arbeit und Soziales (BMAS) </a>
source_organisation_logo_2: <a href="https://www.bmas.de" target="_blank" onclick="return confirm_alert('des Bundesministeriums für Arbeit und Soziales','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/bmas.png" alt="Logo bmas" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
