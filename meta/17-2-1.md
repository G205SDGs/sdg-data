...
# Nationale Metadaten    
national_indicator_available: "<ul style='padding-left: 25px;'><li>Verhältnis der öffentlichen Nettoentwicklungsausgaben zum BNE</li> <li> Verhältnis der bilateralen sowie multilateralen öffentlichen Nettoentwicklungslausgaben für die am wenigsten entwickelten Länder (LDCs) zum BNE</li></ul>"    
comparison_sdg: Die Zeitreihen entsprechen den globalen Metadaten.    
goal_meta_national_link: https://sdg-indikatoren.de/public/MetaDe/17.2.1.pdf    
...
source_url_text_1b: OECD - Gesamtströme nach Geber (ODA+OOF+Private)
...
data_start_values: 
  - field: timeseries
    value: proportion of net oda to gni (%)    
