...
footer_fields:
  ...
  - series: private persons (donors) suspected in the context of corruption offences
    unit: number
    label: Anmerkung
    value: Die Daten betreffen tatverdächtige Gebende mit privaten Anliegen bei Korruptionsstraftaten. Gezählt werden auch jene Gebende, deren Bestechungsversuch von der Zielperson abgelehnt wurde.    

# Grafik Eigenschaften    
graph_titles:
  - series: population who had the impression that public officials are corruptible during their interactions with public agencies in the previous two years
    title: Bevölkerung, die den Eindruck hatte, das Beschäftigte des öffentlichen Dienstes bestechlich waren
  - series: private persons (donors) suspected in the context of corruption offences
