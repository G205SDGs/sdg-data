...
graph_title: Eindruck der Bevölkerung zu Korruption im öffenltichen Dienst sowie tatverdächtige Privatpersonen (Geber) im Rahmen von Korruptionsstraftaten    
graph_type: bar    
graph_limits:
  - unit: "%"
    minimum: 0.0
