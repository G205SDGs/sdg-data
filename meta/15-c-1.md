...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Ausgestellte Dokumente für die Ein- und Ausfuhr von geschützten Arten</li> <li> Beschlagnahmungen durch Behörden im Rahmen des Artenschutzes</li> <li> Genehmigte Ein- und Ausfuhren geschützter Arten</li></ul>"    
comparison_sdg: Die Zeitreihen entsprechen nicht den UN-Metadaten, bieten aber zusätzliche Informationen.    
goal_meta_national_link_De: https://sdg-indikatoren.de/public/MetaDe/15.c.1.pdf
...
source_url_text_1: Anzahl artenschutzrechtlicher Ein- und Ausfuhrdokumente
...
footer_fields:
  - series: documents issued for the import and export of protected species
    label: Anmerkungen
    value: <br>• Teilweise korrigierte Daten.<br>• Die Daten basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.    
