...
source_organisation_logo_1: <a href="https://www.un.org/en/desa" target="_blank" onclick="return confirm_alert('der Hauptabteilung Wirtschaftliche und Soziale Angelegenheiten der Vereinten Nationen','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/desa.png" alt="Logo desa" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
...
source_organisation_2: <a href="https://www.bmi.bund.de/" target="_blank" onclick="return confirm_alert('des Bundesministeriums des Innern','De');" title="Klicken Sie hier um zur Website der Organisation Bundesministerium des Innern (BMI) zu gelangen."> Bundesministerium des Innern (BMI) </a>
source_organisation_logo_2: <a href="https://www.bmi.bund.de/" target="_blank" onclick="return confirm_alert('des Bundesministeriums des Innern','De');"><img src="https://sdg-indikatoren.de/public/OrgImgDe/bmi.png" alt="Logo bmi" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
source_url_2: https://sdg-indikatoren.de/public/UNDESA-Survey_2018_2019.pdf
source_url_text_2: UN DESA-Fragebogen, Bewertung 2018/2019 (nicht auf Deutsch verfügbar)
source_url_alert_2: des Bundesministeriums des Innern
source_url_2b: https://sdg-indikatoren.de/public/UNDESA-Survey_2020_2021.pdf
source_url_text_2b: UN DESA-Fragebogen, Bewertung 2020/2021 (nicht auf Deutsch verfügbar)
source_url_alert_2b: des Bundesministeriums des Innern
...
data_last_update: Zuletzt aktualisiert am 17.01.2022. Sobald Daten für weitere Berichtszeiträume vorliegen, werden diese zeitnah hinzugefügt.    
---
