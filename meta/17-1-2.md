...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Finanzierung der Staatsausgaben durch Steuern</li> <li> Finanzierung der Staatsausgaben durch Steuern und Sozialversicherungsabgaben</li></ul>"    
comparison_sdg: 'Die Zeitreihe "Finanzierung der Staatsausgaben durch Steuern" entspricht den UN-Metadaten. Die Zeitreihe "Finanzierung der Staatsausgaben durch Steuern und Sozialversicherungsabgaben" bietet zusätzliche Informationen.'    
...
graph_title: Finanzierung der Staatsausgaben
graph_subtitle:     
graph_type: bar
graph_stepsize: 
  - step: 10.0    
